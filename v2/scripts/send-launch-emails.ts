...
// ── Email A: Prior Calcutta customers ──────────────────────────
const calcuttaCustomers = [
  'dannyfein@gmail.com',
  'tjh2310@gmail.com',
  'jeff.lorenz@gmail.com',
  'griffinkosonocky@gmail.com',
  'ndweiss23@gmail.com',
  'ira.gluck@gmail.com',
  'ryansg23@gmail.com',
  'tals400@yahoo.com',
  'recoils_fodders_0q@icloud.com',
  'rafael.rojoz@gmail.com',
  'chaselennartson@yahoo.com',
  'jose.rojozam@gmail.com',
  'nightninjarag@gmail.com',
  'kraftm12469@gmail.com',
];

// ── Email B: Survive the Chop subscribers ──────────────────────
const stcSubscribers = [
  'blitzology@gmail.com',
  'davies.max.21@gmail.com',
  'tdemps58@gmail.com',
  'rayfeliu@gmail.com',
  'tony55serrano@yahoo.com',
  'joshuaboutt@gmail.com',
  'craig.williams184@hotmail.com',
  'stephengrivers1@gmail.com',
];
...
async function sendAll() {
  console.log('Sending Email A to', calcuttaCustomers.length, 'Calcutta customers...');

  for (const email of calcuttaCustomers) {
    try {
      const { data, error } = await resend.emails.send({
        from: 'Calcutta Edge <support@calcuttaedge.com>',
        to: email,
        subject: 'Your Calcutta tool got a massive upgrade',
        html: emailAHtml,
      });
      if (error) {
  ...
  console.log('\nSending Email B to', stcSubscribers.length, 'Survive the Chop subscribers...');

  for (const email of stcSubscribers) {
    try {
      const { data, error } = await resend.emails.send({
        from: 'Calcutta Edge <support@calcuttaedge.com>',
        to: email,
        subject: 'March Madness Calcutta — free auction tool',
        html: emailBHtml,
      });
      if (error) {
        console.error(`  ✗ ${email}:`, error.message);
